...
async function runFullTest() {
  ...
  // Wait for reload
  console.log('2. Waiting 8 seconds...');
  ...
  // Open SidePanel directly via URL
  console.log('4. Opening SidePanel directly...');
  ...
  // Find GMGN page
  let gmgnPage = context.pages().find(p => p.url().includes('gmgn.ai/sol/token'));
  if (!gmgnPage) {
    gmgnPage = await context.newPage();
  }
  
  console.log('5. Going to GMGN page...');
  ...
  await sidePanel.screenshot({ path: 'full-auto-v3.png', fullPage: true });
  console.log('\nScreenshot: full-auto-v3.png');
